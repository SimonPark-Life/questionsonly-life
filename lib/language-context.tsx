...
export const t: Translations = {
  ...
  heroDescEn:  { en: '38 stories from the mission field, gathered for small group sharing and discussion.', ko: '선교 현장에서 배운 삶의 이야기 38편 — 소그룹 나눔과 토론을 위해 모았습니다.' },
  allStories:  { en: 'All 38 Stories', ko: '이야기 모음 · 38편' },
  ...
  dlSub:         { en: 'Arrogant Generosity — 38 stories + Read Me First', ko: '베풂의 교만 이야기 — 38편 + 먼저읽어주세요' },
  dlEnDesc:      { en: '39 files: Read Me First + Stories 1–38 in English. Each story file includes the story text, Church Community discussion guide, Community Group discussion guide, and Leader\'s Guide.', ko: '42 files: Read Me First + Stories 1–41 (English).' },
  dlKoDesc:      { en: '39개 파일: 먼저읽어주세요 + 이야기 1–38편 (한국어).', ko: '39개 파일: 먼저읽어주세요 + 이야기 1–38편. 각 이야기 파일에는 이야기 본문, 교회 공동체 나눔 자료, 일반 커뮤니티 나눔 자료, 인도자 가이드가 포함되어 있습니다.' },
